        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
              ...
              >
                  <MenuItem  onClick={handleCloseNavMenu}>
                    ...
                    <Typography sx={{color:'white'}} className="dropdown-text" textAlign="center" >BOOKINGS</Typography>
                    </Link>
                  </MenuItem>

                  <MenuItem  onClick={handleCloseNavMenu}>
                    <Link to='/admin/department'>
                    <Typography sx={{color:'white'}} className="dropdown-text" textAlign="center" >DEPARTMENT</Typography>
                    </Link>
                  </MenuItem>

                  <MenuItem onClick={handleCloseNavMenu}>
                    <Link to="/admin/department/request">
                    <Typography sx={{color:'white'}} className="dropdown-text" textAlign="center" >REQUESTS</Typography>
                    </Link>
                  </MenuItem>
            ...
            <Button
                  ...
                  sx={{ my: 2, color: 'white', display: 'block' , fontSize:'1.2rem', marginLeft:'2rem', fontWeight:'bold' }}
                  className="text-appbar"
                >
                  BOOKINGS
                </Button>
